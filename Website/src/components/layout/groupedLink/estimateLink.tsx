...
const EstimateLink = ({ show, toggle }) => {
  return (
    <div className={"w-full flex flex-col select-none"}>
      <div onClick={() => toggle("estimate")} className={buttonStyle}>
      ...
      {show && (
        <>
          <NavLink className={subButtonStyle} to="/new-estimates">
            {({ isActive }) => (
              <>
                <FaRegFile className={isActive ? subButtonIconActiveStyle : subButtonIconStyle} />
                <h6 className={isActive ? subButtonTextActiveStyle : subButtonTextStyle}>New Estimate</h6>
              </>
            )}
          </NavLink>
          <NavLink className={subButtonStyle} to="/estimates">
            {({ isActive }) => (
              <>
                <FaRegFile className={isActive ? subButtonIconActiveStyle : subButtonIconStyle} />
                <h6 className={isActive ? subButtonTextActiveStyle : subButtonTextStyle}>Estimates List</h6>
              </>
            )}
          </NavLink>
          <NavLink className={subButtonStyle} to="/estimates-templates">
            {({ isActive }) => (
              <>
                <FaRegFile className={isActive ? subButtonIconActiveStyle : subButtonIconStyle} />
                <h6 className={isActive ? subButtonTextActiveStyle : subButtonTextStyle}>Estimates Templates</h6>
              </>
            )}
          </NavLink>
        </>
